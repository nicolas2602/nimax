        ...
        <div class="container">
            <div class="card" style="width: 40rem; height: 28rem">
                <div class="card-body" id="cbody">
                    <h5 style="text-align: center;">Cadastro Empresarial</h5>
                ...
                <div class="row">
                    <div class="col">
                            <div class="input-group mb-2">
                                ...
                                <input class="form-control" type="text" name="cnpj" placeholder="CNPJ" required>
                            </div>
                        </div>
                        <br>
                        <div class="col">
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" name="nomeEmp" placeholder="Nome da empresa" required>
                        </div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="tserv" required>
                                <option selected>Tipos de serviço</option>
                    ...
                    <div class="col">
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" name="end" placeholder="Endereço" required>
                        </div>
                    </div>
                </div><br>
                    ...
                    <div class="col">
                        <div class="input-group mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="parc" required>
                                <option selected>Parceria</option>
