              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td> <?php echo $f['IdCadastro']?> </td>
                      <td><?php echo $f['nomeCad']?></td>
                      <td>
                        
                        <?php 
                            $dataProblema = $f['dataProblema'];
                            echo date('d/m/Y H:i:s', strtotime($dataProblema));
                        ?>

                     </td>

                      <td><span class="tag tag-success"><?php echo $f['descProblema']?></span></td>
                    <form method="POST" enctype="multipart/form-data">
                      <td>                      
                        <div class="input-group input-group-sm">
                          <input type="datetime-local" class="form-control" name="time" value="<?=$f['dataAgenda']; ?>" required>
                          <input type="hidden" name="idusuario" value="<?=$f['IdCadastro']; ?>">
                    ...
                    <tr class="expandable-body bg-light">
                        <td colspan="5">
                          <p>
                            <b>Descrição de <?php echo $f['nomeCad']?>:</b><br/>
                          <?php echo $f['msgProblema']?>
                          </p>
                        </td>
                      </tr>
